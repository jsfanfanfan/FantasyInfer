...
TEST(test_ir, pnnx_graph_ops)
{
     ...
     */
    std::string bin_path("/home/fjs/FantasyInfer/model_file/test_linear.pnnx.bin");
    std::string param_path("/home/fjs/FantasyInfer/model_file/test_linear.pnnx.param");
...
TEST(test_ir, pnnx_graph_all_homework)
{
    ...
    for (const auto &operator_ : operators)
    {
        if (operator_->name == "linear")
        {
            ...
            RuntimeParameter *parameter_bool = params.at("bias").get();
            ...
            RuntimeParameter *parameter_in_features = params.at("in_features").get();
            ...
            RuntimeParameter *parameter_out_features = params.at("out_features").get();
