...
fantasy_infer::sftensor PreProcessImage(const cv::Mat &image,
...
TEST(test_network, yolov5) {
  ...
  for (uint32_t i = 0; i < batch_size; ++i) {
    const std::string &image_path = "/home/fjs/FantasyInfer/model_file/car.jpg";  // 可以放不同的图片
    image_paths.push_back(image_path);
  }
  const std::string &param_path = "/home/fjs/FantasyInfer/model_file/yolov5s.pnnx.param";
  const std::string &bin_path = "/home/fjs/FantasyInfer/model_file/yolov5s.pnnx.bin";
