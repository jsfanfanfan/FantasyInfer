...
#ifndef FANTASY_INFER_DATA_BLOB_HPP_
#define FANTASY_INFER_DATA_BLOB_HPP_
#include <armadillo>
#include <memory>
#include <vector>
...
namespace fantasy_infer
{
    ...
    private:
        std::vector<uint32_t> raw_shapes_; // 张量数据的实际数据维度大小
        // pytorch 默认行主序，armadillo 默认列主序
        arma::fcube data_;                 // 张量本身数据
    };
...
#endif // FANTASY_INFER_DATA_BLOB_HPP_