#ifndef FANTASY_INFER_INCLUDE_PARSER_RUNTIME_OPERAND_HPP_
#define FANTASY_INFER_INCLUDE_PARSER_RUNTIME_OPERAND_HPP_
#include <vector>
#include <string>
#include <memory>
...
#endif // FANTASY_INFER_INCLUDE_PARSER_RUNTIME_OPERAND_HPP_
