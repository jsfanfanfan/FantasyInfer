#ifndef FANTASY_INFER_SOURCE_LAYER_LAYER_HPP_
#define FANTASY_INFER_SOURCE_LAYER_LAYER_HPP_
...
namespace fantasy_infer
{
    ...
    public:
        ...
        /**
         * Layer 是所有算子的父类
         * Layer 的前向传播执行函数 每个派生类算子需要重载 Forward 方法
         * @param 输入 tensor
         * @param 输出 tensor
         * @return 执行的状态
         */
    ...
    protected:
        std::weak_ptr<RuntimeOperator> runtime_operator_; // Layer 执行的 RuntimeOperator
        std::string layer_name_; /// Layer的名称
    };

} // namespace fantasy_infer
#endif // FANTASY_INFER_SOURCE_LAYER_LAYER_HPP_
